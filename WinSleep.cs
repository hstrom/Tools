...
namespace Tools
{
    public static class WinSleep
    {
        ...
        {
            API.SetThreadExecutionState(keepDisplayOn
                ? API.ExecutionState.Continuous | API.ExecutionState.SystemRequired | API.ExecutionState.DisplayRequired
                : API.ExecutionState.Continuous | API.ExecutionState.SystemRequired);
        }
        ...
        {
            API.SetThreadExecutionState(API.ExecutionState.Continuous);
        }
        ...
        {
            API.SetThreadExecutionState(keepDisplayOn
                ? API.ExecutionState.SystemRequired | API.ExecutionState.DisplayRequired
                : API.ExecutionState.SystemRequired);
        }
    }
}
